...
$pageTitle = "Editorial - Kürşad Karakuş Digital Portfolio";
$categoryFilter = 'editorial';

// project_layouts tablosu var mı kontrol et
$layoutsTableExists = false;
$pageType = $categoryFilter; // editorial, advertising, film, cover
try {
    ...
    <div class="grid">
      ...
      ?>>
        <?php if (empty($projects)): ?>
            <div class="box">
                <h2><?php echo t('category.editorial'); ?></h2>
                <p><?php echo t('category.editorial_no_projects'); ?></p>
